...
public class U7Paired extends actr.task.Task
{
	TaskLabel label;
	double lastTime = 0;
	...
	U7PairedTrial currentTrial;
	U7PairedResult currentResult;
	...
	class U7PairedResult extends actr.task.Result
	{
		Vector<U7PairedTrial> trials;
		U7PairedResult () { trials = new Vector<U7PairedTrial>(); }
	}
	...
	public void start ()
	{
		...
		response = null;
		responseTime = 0;
		currentTrial = new U7PairedTrial();
		currentResult = new U7PairedResult();
	...
	public U7PairedResult getResult ()
	{
	...
	public void analyze (Result[] results)
	{
		...
		for (int i=0 ; i<runIterations ; i++)
		{
			...
			{
				U7PairedResult result = (U7PairedResult) results[j];
